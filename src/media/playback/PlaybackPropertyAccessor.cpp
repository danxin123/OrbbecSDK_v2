...
PlaybackFrameTransformPropertyAccessor::PlaybackFrameTransformPropertyAccessor(const std::shared_ptr<ISourcePort> &backend, IDevice *owner)
    ...
    auto vid = owner_->getInfo()->vid_;
    if(isDeviceInContainer(G330DevPids, vid, pid) || isDeviceInContainer(DaBaiADevPids, vid, pid) || isDeviceInContainer(G435LeDevPids, vid, pid)) {
...
void PlaybackFrameTransformPropertyAccessor::initFrameTransformProperty() {
    ...
    std::vector<uint32_t> list      = {
        OB_PROP_COLOR_MIRROR_BOOL,      OB_PROP_COLOR_FLIP_BOOL,       OB_PROP_COLOR_ROTATE_INT,        OB_PROP_COLOR_LEFT_MIRROR_BOOL,
        OB_PROP_COLOR_LEFT_FLIP_BOOL,   OB_PROP_COLOR_LEFT_ROTATE_INT, OB_PROP_COLOR_RIGHT_MIRROR_BOOL, OB_PROP_COLOR_RIGHT_FLIP_BOOL,
        OB_PROP_COLOR_RIGHT_ROTATE_INT, OB_PROP_DEPTH_FLIP_BOOL,       OB_PROP_DEPTH_MIRROR_BOOL,       OB_PROP_DEPTH_ROTATE_INT,
        OB_PROP_IR_FLIP_BOOL,           OB_PROP_IR_MIRROR_BOOL,        OB_PROP_IR_ROTATE_INT,           OB_PROP_IR_RIGHT_FLIP_BOOL,
        OB_PROP_IR_RIGHT_MIRROR_BOOL,   OB_PROP_IR_RIGHT_ROTATE_INT,   OB_PROP_CONFIDENCE_FLIP_BOOL,    OB_PROP_CONFIDENCE_MIRROR_BOOL,
