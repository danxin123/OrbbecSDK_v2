...
void G2AlgParamManager::registerBasicExtrinsics() {
    ...
    auto confidenceBasicStreamProfile =
        StreamProfileFactory::createVideoStreamProfile(OB_STREAM_CONFIDENCE, OB_FORMAT_ANY, OB_WIDTH_ANY, OB_HEIGHT_ANY, OB_FPS_ANY);
