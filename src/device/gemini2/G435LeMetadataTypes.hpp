...
#include "metadata/FrameMedatadaTypes.hpp"
...
struct G435LeColorUvcMetadata : public G435LeCommonUvcMetadata {
...
struct G435LeDepthUvcMetadata : public G435LeCommonUvcMetadata {
    uint16_t height;
    uint16_t width;
    uint16_t gain_level;
    uint16_t white_balance;
