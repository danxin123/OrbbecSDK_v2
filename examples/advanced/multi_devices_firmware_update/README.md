# Multi Devices Firmware Update

## Overview

If you want to upgrade multiple cameras connected to your system, this sample might be helpful for you. For detailed information about firmware upgrades, please refer to the [Firmware Update](../../beginner/09_firmware_update/README.md).
